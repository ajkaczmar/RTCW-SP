...
void GL_SelectTexture( int unit ) {
	...
	if ( unit == 0 ) {
		...
		GLimp_LogComment( "glActiveTextureARB( GL_TEXTURE0 )\n" );
	} else if ( unit == 1 )   {
		qglActiveTexture( GL_TEXTURE1 );
		GLimp_LogComment( "glActiveTextureARB( GL_TEXTURE1 )\n" );
	}
	else if (unit == 2) {
		qglActiveTexture(GL_TEXTURE2);
		GLimp_LogComment("glActiveTextureARB( GL_TEXTURE2 )\n");
	}
	else if (unit == 3) {
		qglActiveTexture(GL_TEXTURE3);
		GLimp_LogComment("glActiveTextureARB( GL_TEXTURE3 )\n");
	} else {
